import { UserGroupIcon, ChatBubbleBottomCenterTextIcon, DocumentIcon } from "@heroicons/react/24/outline";
...
export default function Card({ title, value, type }) {
  ...
  return (
    <div className="rounded-xl bg-secondary-50 p-2 shadow-sm">
      ...
      <p className={`truncate rounded-xl bg-secondary-0 px-4 py-8 text-center text-2xl text-secondary-500`}>{value}</p>
    </div>
  );
}
